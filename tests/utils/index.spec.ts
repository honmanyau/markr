...
describe('/test/utils/index.ts', () => {
  describe('createDocument()', () => {
    ...
    it('should create a document that matches the sample input for a 2 entries.', () => {
      const datetimeString = '2017-12-04T12:12:10+11:00';
      const datetimeString2 = '2017-12-04T12:14:11+11:00';
      const isoDatetimeString = new Date(datetimeString).toISOString();
      const isoDatetimeString2 = new Date(datetimeString2).toISOString();
      const expected = [
        '<mcq-test-results>',
        `<mcq-test-result scanned-on="${isoDatetimeString}">`,
        '<first-name>KJ</first-name>',
  ...
  describe('createEntry()', () => {
    it('should create an entry that matches the sample input.', () => {
      const datetimeString = '2017-12-04T12:12:10+11:00';
      const isoDatetimeString = new Date(datetimeString).toISOString();
      const expected = [
        `<mcq-test-result scanned-on="${isoDatetimeString}">`,
